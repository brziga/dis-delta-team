...
class detect_faces(Node):
	...
	def __init__(self):
		...
		# publishing detected objects
		self.object_publisher = self.create_publisher(DetectedObjects, 'some_detected_object', 1)
	...
	def pointcloud_callback(self, data):
		...
		for bb1x, bb1y, bb2x, bb2y, bb3x, bb3y, bb4x, bb4y in self.bounding_box:
			...
			# now sending message to object_identifier
			msg = DetectedObjects()
			msg.position_x = v_center[0]
			msg.position_y = v_center[1]
			msg.position_z = v_center[2]
			msg.park_position_x = v_final_result[0]
			msg.park_position_y = v_final_result[1]
			msg.park_position_z = v_final_result[2]
