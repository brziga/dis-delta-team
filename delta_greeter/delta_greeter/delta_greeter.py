...
class Greeter(Node):
    ...
    def greet_a_person(self, position_x, position_y, position_z, rotation):
        ...
        #just to simulate delay of greeting task
        #time.sleep(5)
        
        # TODO: Perform greeting here!
        moveToPosition(position_x,position_y,rotation)
        self.get_logger().info('dober dan person! Finished greeting job with id: '+self.id_of_current_job)
