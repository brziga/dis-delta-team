...
def main(args=None):
    ...
    rc.spin(-0.5)
"""
    data = [[-0.5, 0.2, 0.8],[-0.4, 0.0, 0.0],[-0.3, -0.3, -0.3],[-0.3, -1.0, 0.0],[-0.3, -1.6, -0.8],[-0.3, -1.6, -1.6],[-0.3, -1.6, -2.4],[-0.3, -1.6, -3.1]]
    ...
    for i in range(len(data)):
        ...
        goal_pose.pose.position.x = data[i][0]
        goal_pose.pose.position.y = data[i][1]
        goal_pose.pose.orientation = rc.YawToQuaternion(data[i][2])
    ...
    while userInput == 0:
        ...
        goal_pose.pose.orientation = rc.YawToQuaternion(rot)
